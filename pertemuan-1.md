...
Pada terminal yang sudah terbuka, jalankan perintah berikut untuk membuat project baru bernama pertemuan-1:composer create-project laravel/laravel:^12.0 pertemuan-1

Tunggu hingga proses pengunduhan _package_ selesai.

### Langkah 2: Masuk ke Direktori Project

Setelah proses instalasi selesai, masuk ke dalam folder project yang baru saja dibuat:cd pertemuan-1

### Langkah 3: Menjalankan Local Development Server

Untuk menjalankan project Laravel, gunakan perintah _Artisan_ berikut:php artisan serve
